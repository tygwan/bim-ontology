...
> Compact routing index for 26 agents. Load individual agent files only when matched.
...
| codex-reviewer | codex 검증, 교차 검증, AI 리뷰, 코드 검증 | codex review, cross review, dual review, codex check | Codex CLI 기반 교차 검증 (코드/테스트/문서) |
